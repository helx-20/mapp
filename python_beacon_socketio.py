...
load_dotenv()
api_key = os.environ.get('MCITY_OCTANE_KEY', '7AaZH0x9Fo')
...
def on_beacon_update(data):
    ...
    if data['id'] == vehicle_id:
        print(data)
        # print(data['state']['dynamics']['latitude'])
        # print(data['state']['dynamics']['longitude'])
        # print(data['state']['dynamics']['velocity'])
        # print(data['state']['dynamics']['heading'])
        # print(data['state']['dynamics']['acceleration'])
        # print(data['state']['dynamics']['updated'])
